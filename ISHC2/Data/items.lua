...
PlaceObj('ModItemBuildingTemplate', {
	...
	'pin_rollover_hint', T{123128587649, --[[ModItemBuildingTemplate AdsorptionOxygenPlant pin_rollover_hint]] "<image UI/Infopanel/left_click.tga 1400> Select"},
	'pin_rollover_hint_xbox', T{267660707568, --[[ModItemBuildingTemplate AdsorptionOxygenPlant pin_rollover_hint_xbox]] "<image UI/PS4/Cross.tga> View"},
	...
	'upgrade1_display_name', T{750665534784, --[[ModItemBuildingTemplate AdsorptionOxygenPlant upgrade1_display_name]] "Magnetic Filtering"},
	'upgrade1_description', T{458277012333, --[[ModItemBuildingTemplate AdsorptionOxygenPlant upgrade1_description]] "+<upgrade1_mul_value_1>% Production."},
...
PlaceObj('ModItemBuildingTemplate', {
	...
	'pin_rollover_hint', T{263993659428, --[[ModItemBuildingTemplate Tier5Dome pin_rollover_hint]] "<image UI/Infopanel/left_click.tga 1400> Select"},
	'pin_rollover_hint_xbox', T{690376387842, --[[ModItemBuildingTemplate Tier5Dome pin_rollover_hint_xbox]] "<image UI/PS4/Cross.tga> View"},
	'pin_summary1', T{296962602464, --[[ModItemBuildingTemplate Tier5Dome pin_summary1]] "<GetColonistCount><image UI/Icons/res_colonist.tga 800>"},
	'pin_on_start', true,
	...
	'display_name', T{834918135406, --[[ModItemBuildingTemplate Tier5Dome display_name]] "Tier 5 Geoscape Dome"},
	'display_name_pl', T{817134113041, --[[ModItemBuildingTemplate Tier5Dome display_name_pl]] "Geoscape Domes"},
	'description', T{704653794250, --[[ModItemBuildingTemplate Tier5Dome description]] "This expensive End Game Dome offers a slice of Earth on Mars, this Dome increases the Comfort of all Residences within. It also increases the Sanity of its inhabitants every Sol. This Dome is sponsored by The Interstellar Habitation Coalition."},
...
PlaceObj('ModItemBuildingTemplate', {
	...
	'pin_rollover_hint', T{728523376282, --[[ModItemBuildingTemplate StartingDome pin_rollover_hint]] "<image UI/Infopanel/left_click.tga 1400> Select"},
	'pin_rollover_hint_xbox', T{869423683165, --[[ModItemBuildingTemplate StartingDome pin_rollover_hint_xbox]] "<image UI/PS4/Cross.tga> View"},
	'pin_summary1', T{321688078845, --[[ModItemBuildingTemplate StartingDome pin_summary1]] "<GetColonistCount><image UI/Icons/res_colonist.tga 800>"},
	'pin_on_start', true,
	...
	'display_name', T{376760424207, --[[ModItemBuildingTemplate StartingDome display_name]] "Emergency Dome"},
	'display_name_pl', T{295303744176, --[[ModItemBuildingTemplate StartingDome display_name_pl]] "Emergency Domes"},
	'description', T{792121260460, --[[ModItemBuildingTemplate StartingDome description]] "An Emergency Dome suitable for the early days of the Colony. You will be given half of the original cost upon demolition."},
	'build_category', "Domes",
...
PlaceObj('ModItemBuildingTemplate', {
	...
	'pin_rollover_hint', T{572628265240, --[[ModItemBuildingTemplate HighGradeSolarArray pin_rollover_hint]] "<image UI/Infopanel/left_click.tga 1400> Select"},
	'pin_rollover_hint_xbox', T{873311613950, --[[ModItemBuildingTemplate HighGradeSolarArray pin_rollover_hint_xbox]] "<image UI/PS4/Cross.tga> View"},
	...
	'display_name', T{974200154738, --[[ModItemBuildingTemplate HighGradeSolarArray display_name]] "High Grade Solar Array"},
	'display_name_pl', T{589463928608, --[[ModItemBuildingTemplate HighGradeSolarArray display_name_pl]] "High-Grade Solar Arrays"},
	'description', T{351783482800, --[[ModItemBuildingTemplate HighGradeSolarArray description]] "The Interstellar Habitation Coalition provides you with a High Grade Solar Array. The effectiveness is decreased by dust accumulation and during Dust Storms. Protected from dust while turned off."},
...
PlaceObj('ModItemBuildingTemplate', {
	...
	'pin_rollover_hint', T{677740854741, --[[ModItemBuildingTemplate Tier4Dome pin_rollover_hint]] "<image UI/Infopanel/left_click.tga 1400> Select"},
	'pin_rollover_hint_xbox', T{933693832590, --[[ModItemBuildingTemplate Tier4Dome pin_rollover_hint_xbox]] "<image UI/PS4/Cross.tga> View"},
	'pin_summary1', T{585805402101, --[[ModItemBuildingTemplate Tier4Dome pin_summary1]] "<GetColonistCount><image UI/Icons/res_colonist.tga 800>"},
	'pin_on_start', true,
	...
	'display_name', T{605275257287, --[[ModItemBuildingTemplate Tier4Dome display_name]] "Tier 4 Oval Dome"},
	'display_name_pl', T{351894014314, --[[ModItemBuildingTemplate Tier4Dome display_name_pl]] "Oval Domes"},
	'description', T{335628548239, --[[ModItemBuildingTemplate Tier4Dome description]] "This Dome is slightly more expensive than the rest, but provides an elongated Dome design which has space for two Spires. This design was created by the top engineers in The Interstellar Habitation Coalition."},
	'build_category', "Domes",
...
PlaceObj('ModItemBuildingTemplate', {
	...
	'pin_rollover_hint', T{544806942120, --[[ModItemBuildingTemplate Tier3Dome pin_rollover_hint]] "<image UI/Infopanel/left_click.tga 1400> Select"},
	'pin_rollover_hint_xbox', T{834096002747, --[[ModItemBuildingTemplate Tier3Dome pin_rollover_hint_xbox]] "<image UI/PS4/Cross.tga> View"},
	'pin_summary1', T{385088152462, --[[ModItemBuildingTemplate Tier3Dome pin_summary1]] "<GetColonistCount><image UI/Icons/res_colonist.tga 800>"},
	'pin_on_start', true,
	...
	'display_name', T{838630005328, --[[ModItemBuildingTemplate Tier3Dome display_name]] "Tier 3 Mega Dome"},
	'display_name_pl', T{201575495693, --[[ModItemBuildingTemplate Tier3Dome display_name_pl]] "Mega Domes"},
	'description', T{335438813263, --[[ModItemBuildingTemplate Tier3Dome description]] "This advanced and spacious Dome is a new design from The Interstellar Habitation Coalition."},
	'build_category', "Domes",
...
PlaceObj('ModItemBuildingTemplate', {
	...
	'pin_rollover_hint', T{878233651750, --[[ModItemBuildingTemplate Tier2Dome pin_rollover_hint]] "<image UI/Infopanel/left_click.tga 1400> Select"},
	'pin_rollover_hint_xbox', T{672705994308, --[[ModItemBuildingTemplate Tier2Dome pin_rollover_hint_xbox]] "<image UI/PS4/Cross.tga> View"},
	'pin_summary1', T{377419537452, --[[ModItemBuildingTemplate Tier2Dome pin_summary1]] "<GetColonistCount><image UI/Icons/res_colonist.tga 800>"},
	'pin_on_start', true,
	...
	'maintenance_resource_type', "Concrete",
	'maintenance_resource_amount', 20000,
	'display_name', T{789772904277, --[[ModItemBuildingTemplate Tier2Dome display_name]] "Tier 2 Medium Dome"},
	'display_name_pl', T{333837798202, --[[ModItemBuildingTemplate Tier2Dome display_name_pl]] "Medium Domes"},
	'description', T{281548422335, --[[ModItemBuildingTemplate Tier2Dome description]] "A medium-sized Dome design brought to you by The Interstellar Habitation Coalition."},
	'build_category', "Domes",
...
PlaceObj('ModItemBuildingTemplate', {
	...
	'template_class', "SolarPanel",
	'pin_rollover_context', "electricity",
	'pin_rollover_hint', T{543938879316, --[[ModItemBuildingTemplate SmallDomeSolarPanel pin_rollover_hint]] "<image UI/Infopanel/left_click.tga 1400> Select"},
	'pin_rollover_hint_xbox', T{657085690201, --[[ModItemBuildingTemplate SmallDomeSolarPanel pin_rollover_hint_xbox]] "<image UI/PS4/Cross.tga> View"},
	'construction_cost_Concrete', 5000,
	'construction_cost_Metals', 5000,
	...
	'maintenance_resource_amount', 2000,
	'display_name', T{112041214185, --[[ModItemBuildingTemplate SmallDomeSolarPanel display_name]] "Small Dome Solar Panel"},
	'display_name_pl', T{290369299327, --[[ModItemBuildingTemplate SmallDomeSolarPanel display_name_pl]] "Small Dome Solar Panels"},
	'description', T{745750168204, --[[ModItemBuildingTemplate SmallDomeSolarPanel description]] "The Interstellar Habitation Coalition provides you with a Dome variant of the Solar Panel."},
	'build_category', "Power",
...
PlaceObj('ModItemBuildingTemplate', {
	...
	'template_class', "MOXIE",
	'pin_rollover_context', "air",
	'pin_rollover_hint', T{541122220112, --[[ModItemBuildingTemplate CryogenicOxygenPlant pin_rollover_hint]] "<image UI/Infopanel/left_click.tga 1400> Select"},
	'pin_rollover_hint_xbox', T{722276631521, --[[ModItemBuildingTemplate CryogenicOxygenPlant pin_rollover_hint_xbox]] "<image UI/PS4/Cross.tga> View"},
	...
	'is_tall', true,
	'upgrade1_id', "MOXIE_MagneticFiltering",
	'upgrade1_display_name', T{387311341520, --[[ModItemBuildingTemplate CryogenicOxygenPlant upgrade1_display_name]] "Magnetic Filtering"},
	'upgrade1_description', T{740442728942, --[[ModItemBuildingTemplate CryogenicOxygenPlant upgrade1_description]] "+<upgrade1_mul_value_1>% Production."},
	'upgrade1_icon', "UI/Icons/Upgrades/magnetic_filtering_01.tga",
	'upgrade1_upgrade_cost_Polymers', 5000,
	'upgrade1_mod_label_1', "MOXIE",
	'upgrade1_mod_prop_id_1', "air_production",
...
PlaceObj('ModItemBuildingTemplate', {
	...
	'template_class', "SolarPanel",
	'pin_rollover_context', "electricity",
	'pin_rollover_hint', T{241329923385, --[[ModItemBuildingTemplate LargeDomeSolarPanel pin_rollover_hint]] "<image UI/Infopanel/left_click.tga 1400> Select"},
	'pin_rollover_hint_xbox', T{114245170729, --[[ModItemBuildingTemplate LargeDomeSolarPanel pin_rollover_hint_xbox]] "<image UI/PS4/Cross.tga> View"},
	'construction_cost_Concrete', 10000,
	...
	'display_name', T{815720015616, --[[ModItemBuildingTemplate LargeDomeSolarPanel display_name]] "Large Dome Solar Panel"},
	'display_name_pl', T{849098258517, --[[ModItemBuildingTemplate LargeDomeSolarPanel display_name_pl]] "Large Dome Solar Panels"},
	'description', T{690269541436, --[[ModItemBuildingTemplate LargeDomeSolarPanel description]] "The Interstellar Habitation Coalition provides you with a Dome variant of the Large Solar Panel."},
	'build_category', "Power",
...
PlaceObj('ModItemBuildingTemplate', {
	...
	'pin_rollover_hint', T{399854750632, --[[ModItemBuildingTemplate RecyclingCenter pin_rollover_hint]] "<image UI/Infopanel/left_click.tga 1400> Select"},
	'pin_rollover_hint_xbox', T{196262477599, --[[ModItemBuildingTemplate RecyclingCenter pin_rollover_hint_xbox]] "<image UI/PS4/Cross.tga> View"},
	...
	'upgrade1_display_name', T{732959747537, --[[ModItemBuildingTemplate RecyclingCenter upgrade1_display_name]] "Factory-AI"},
	'upgrade1_description', T{575737714691, --[[ModItemBuildingTemplate RecyclingCenter upgrade1_description]] "+<upgrade1_mul_value_1> % Production"},
	...
	'upgrade2_display_name', T{565190910348, --[[ModItemBuildingTemplate RecyclingCenter upgrade2_display_name]] "Automation"},
	'upgrade2_description', T{665347070625, --[[ModItemBuildingTemplate RecyclingCenter upgrade2_description]] "Decreasing work places <abs(upgrade2_add_value_1)>."},
	...
	'upgrade3_display_name', T{584522624715, --[[ModItemBuildingTemplate RecyclingCenter upgrade3_display_name]] "Amplifying"},
	'upgrade3_description', T{550968617327, --[[ModItemBuildingTemplate RecyclingCenter upgrade3_description]] "+<upgrade3_mul_value_1> % Production; + Consumption."},
	...
	'display_name', T{334296783255, --[[ModItemBuildingTemplate RecyclingCenter display_name]] "Recycling Center"},
	'display_name_pl', T{678525201599, --[[ModItemBuildingTemplate RecyclingCenter display_name_pl]] "Recycling Centers"},
	'description', T{851285543999, --[[ModItemBuildingTemplate RecyclingCenter description]] "Recycling Center for outdated electronics/machine parts. Will yield exportable metals, metal, and polymers back."},
...
PlaceObj('ModItemBuildingTemplate', {
	...
	'template_class', "MOXIE",
	'pin_rollover_context', "air",
	'pin_rollover_hint', T{889286447841, --[[ModItemBuildingTemplate InDomeMOXIE pin_rollover_hint]] "<image UI/Infopanel/left_click.tga 1400> Select"},
	'pin_rollover_hint_xbox', T{867187875459, --[[ModItemBuildingTemplate InDomeMOXIE pin_rollover_hint_xbox]] "<image UI/PS4/Cross.tga> View"},
	'construction_cost_Metals', 10000,
	'construction_cost_Polymers', 5000,
	'construction_cost_Electronics', 5000,
	'construction_cost_MachineParts', 5000,
	...
	'dome_required', true,
	'upgrade1_id', "MOXIE_MagneticFiltering",
	'upgrade1_display_name', T{264887206107, --[[ModItemBuildingTemplate InDomeMOXIE upgrade1_display_name]] "Magnetic Filtering"},
	'upgrade1_description', T{473252317825, --[[ModItemBuildingTemplate InDomeMOXIE upgrade1_description]] "+<upgrade1_mul_value_1>% Production."},
	'upgrade1_icon', "UI/Icons/Upgrades/magnetic_filtering_01.tga",
	'upgrade1_upgrade_cost_Polymers', 5000,
	'upgrade1_mod_label_1', "MOXIE",
	'upgrade1_mod_prop_id_1', "air_production",
	...
	'display_name', T{364063321623, --[[ModItemBuildingTemplate InDomeMOXIE display_name]] "In-Dome MOXIE"},
	'display_name_pl', T{244340625090, --[[ModItemBuildingTemplate InDomeMOXIE display_name_pl]] "In-Dome MOXIEs"},
	'description', T{436754750300, --[[ModItemBuildingTemplate InDomeMOXIE description]] "Dome specific MOXIE which produces Oxygen at an increased production rate (+4 O2 p/h). Production is not affected during Dust Storms. Can be upgraded with Magnetic Filtering to increase the production rate (+6 O2 p/h)."},
	'build_category', "Life-Support",
	'display_icon', "UI/Icons/Buildings/moxie.tga",
	'entity', "Moxie",
	'encyclopedia_text', T{487668102261, --[[ModItemBuildingTemplate InDomeMOXIE encyclopedia_text]] "MOXIE instruments, which employ MOXIE (short for Mars Oxygen In situ resource utilization Experiment) technology, produce Oxygen from the rich amounts of carbon dioxide in the Martian atmosphere.<newline><newline><center><image UI/Common/rollover_line.tga 2000> <left><newline><newline>Developed in the 20th century but first tested on a rover mission to Mars in the early 20s of the 21st century, that once experimental technology now forms the backbone of life support in our first Colony on an alien world.<newline><newline>These instruments require nothing but power and regular maintenance and, of course, a connection to the lifeline of our Colony."},
...
PlaceObj('ModItemBuildingTemplate', {
	...
	'template_class', "MOXIE",
	'pin_rollover_context', "air",
	'pin_rollover_hint', T{985486761314, --[[ModItemBuildingTemplate MembraneOxygenPlant pin_rollover_hint]] "<image UI/Infopanel/left_click.tga 1400> Select"},
	'pin_rollover_hint_xbox', T{168139725989, --[[ModItemBuildingTemplate MembraneOxygenPlant pin_rollover_hint_xbox]] "<image UI/PS4/Cross.tga> View"},
	...
	'is_tall', true,
	'upgrade1_id', "MOXIE_MagneticFiltering",
	'upgrade1_display_name', T{278851930209, --[[ModItemBuildingTemplate MembraneOxygenPlant upgrade1_display_name]] "Magnetic Filtering"},
	'upgrade1_description', T{418300641917, --[[ModItemBuildingTemplate MembraneOxygenPlant upgrade1_description]] "+<upgrade1_mul_value_1>% Production."},
	'upgrade1_icon', "UI/Icons/Upgrades/magnetic_filtering_01.tga",
	'upgrade1_upgrade_cost_Polymers', 5000,
	'upgrade1_mod_label_1', "MOXIE",
	'upgrade1_mod_prop_id_1', "air_production",
	...
	'maintenance_resource_type', "Polymers",
	'maintenance_resource_amount', 20000,
	'display_name', T{262912216226, --[[ModItemBuildingTemplate MembraneOxygenPlant display_name]] "Membrane Oxygen Plant"},
	'display_name_pl', T{234313081869, --[[ModItemBuildingTemplate MembraneOxygenPlant display_name_pl]] "Membrane Oxygen Plants"},
	'description', T{591316388714, --[[ModItemBuildingTemplate MembraneOxygenPlant description]] "Oxygen plants are industrial systems designed to generate oxygen. They typically use air as a feedstock and separate it from other components of air using pressure swing adsorption or membrane separation techniques. Such plants are distinct from cryogenic separation plants which separate and capture all the components of air. Produces Oxygen at an increased production rate (+10 O2 p/h). Can be upgraded with Magnetic Filtering to increase the production rate (+15 O2 p/h). "},
	'build_category', "Life-Support",
